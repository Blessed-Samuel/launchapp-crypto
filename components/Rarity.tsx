        ...
        <section id="rarity" className="mb-16 mt-48">
            <div className="space-y-48 md:px-0 px-6">
                <div className="flex flex-col md:flex-row gap-14 items-center">
                    ...
                    <Image src="./Card-1.svg" alt="card-1-image" width={100} height={100} className="w-auto h-auto"/>
                </div>
                ...
                <div className="flex flex-col md:flex-row-reverse gap-14 items-center">
                    ...
                    <Image src="./Card-2.svg" alt="card-2-image" width={100} height={100} className="w-auto h-auto"/>
                </div>
            </div>
        </section>
    );
