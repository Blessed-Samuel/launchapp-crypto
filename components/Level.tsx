        ...
        <section id="rarity" className="mb-16 mt-60">
            <div className="md:px-0 px-6">
                <div className="flex flex-col md:flex-row gap-14 items-center">
                    <div className="mb-14">
                        <h1 className="text-3xl font-extrabold mb-6 text-gray-300">Download Betterstep</h1>
                ...
                <div className="flex flex-col md:flex-row-reverse gap-14 items-center">
                    <div className="mb-14">
                        <h1 className="text-sm font-extrabold mb-6 text-gray-300">Walk, Earn, and Thrive</h1>
